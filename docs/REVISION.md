...
- README gerçek adresi, hesap seçimini, üretim çıktısının doğrulanmasını ve tekrar yayın adımlarını içerir. İlk yayın tesliminde GitHub Private olarak doğrulandı; main'e birleştirme, force push, gerçek rezervasyon veya ödeme entegrasyonu yapılmadı.
...
- [Yayın sonrası CI da başarılı](https://github.com/furkan-akpinar/vanta-drive/actions/runs/34254371372): gerçek URL'de 321 sayfa/SEO/medya kontrolü, 96 etkileşim/yolculuk ve Chromium/WebKit'te 353 menü kontrolü geçti. Küçük iş günlüğü indirilerek 12 profil ve sıfır hata doğrudan doğrulandı. Büyük canlı kanıt arşivinin yerel indirmesi zaman aşımına uğradı; arşiv GitHub'da korunur, yerel üretim önce/sonra görüntüleri yukarıdadır.
- **Görünürlük düzeltmesi:** Önceki yayının 15:20 UTC kaydında repo Private idi. Bu menü görevinin ilk API sorgusunda (16:18 UTC, başlangıç SHA `6751449`) ise zaten Public idi ve görev sonunda da Public kaldı. Görevde GitHub görünürlük ayarına yazma işlemi yapılmadı. Eski Private ifadesi başlangıç kaydıyla karşılaştırılmadan tekrarlandığı için README düzeltildi; mevcut görünürlüğü koruma talimatına uyuldu.
